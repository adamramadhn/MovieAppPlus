...
import com.adam.movieapp.databinding.FragmentHomeBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null) {
            ...
            homeViewModel.tourism.observe(viewLifecycleOwner, {
                if (it != null) {
                    when (it) {
                        is com.adam.movieapp.core.data.Resource.Loading -> binding.progressBar.visibility = View.VISIBLE
                        is com.adam.movieapp.core.data.Resource.Success -> {
                            binding.progressBar.visibility = View.GONE
                            movieAdapter.setData(it.data)
                        }
                        is com.adam.movieapp.core.data.Resource.Error -> {
                            binding.progressBar.visibility = View.GONE
